...
class MyModelLoss(LossInterface):
    ...
    def get_loss_G(self, run_dict, valid=False):
        ...
        if 'W_LPIPS' in self.CONFIG['LOSS']:
        ...
        if 'W_RECON' in self.CONFIG['LOSS']:
        ...
        if 'W_CYCLE' in self.CONFIG['LOSS']:
